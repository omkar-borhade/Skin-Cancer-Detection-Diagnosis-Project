...
function Home() {
  ...
  return (
    <div>
      <Carousel />
      <div className="container mx-auto px-4 sm:px-6 md:px-8 lg:px-10 py-4">
        <h2 className="text-center text-2xl sm:text-3xl md:text-4xl mt-8 mb-4">Types of Skin Cancer</h2>
