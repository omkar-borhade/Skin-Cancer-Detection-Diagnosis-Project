...
//       if (res.ok) {
//         console.log("✅ Uploaded to GitHub:", result.downloadUrl);
...
// const fixedDownloadUrl = "https://raw.githubusercontent.com/omkar-borhade/Skin_report/main/Report.pdf";
...
//             {/* QR Code */}
//             <div className="flex justify-end">
//              <QRCode value={fixedDownloadUrl} size={50} />
//             </div>
...
// <div className="flex flex-col sm:flex-row justify-center sm:justify-between items-center space-y-2 sm:space-y-0 sm:space-x-4 pt-4">
//   <button
//     className={`py-2 px-4 rounded-lg shadow-md w-full sm:w-auto 
//       ${isUploaded 
